!(function (e) {
  ...
  let acf_accords = document.querySelectorAll('.acf-accordion-title');
  if(acf_accords){
  acf_accords.forEach((el) => {
  ...
  fields.forEach((fil) => {
      ...
      if(buttonEl){
          buttonEl.addEventListener("click", ()=>{
            if(fil.classList.contains('open_field')){
              fil.classList.remove('open_field')
            }else{
